	...
	<body>
		<div class="container">
		    ...
		    <div class="jumbotron">
				...
				<p class="lead">
					Due to the internal error your order was canceled and nothing was charged from your card.
					And we are so sorry about that!
				</p>
				</br>
				<p>
					<a class="btn btn-lg btn-danger" href="order.jsp" role="button">Please, try again ;)</a>
				</p>
			</div>
